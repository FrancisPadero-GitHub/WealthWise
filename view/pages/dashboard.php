<main>
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="">WealthWise</a></li>
            ...
            <div class="card info-card income-card">
              ...
              <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ps-3">
                    <h6 class="text-success">$3,264</h6>
                ...
                <tbody>
                  ...
                  if ($result && $result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                      ...
                      echo "<td><a href='#' class='text-primary'>" . htmlspecialchars($row['description']) . "</a></td>";
